...
@Component({
  selector: 'cherrycoder91-development-page-2',
  imports: [
    ButtonModule,
    TextareaModule,
    FormsModule,
  ...
  templateUrl: './development-page-2.html',
  styleUrl: './development-page-2.css'
})
export class DevelopmentPage2 implements OnInit {
